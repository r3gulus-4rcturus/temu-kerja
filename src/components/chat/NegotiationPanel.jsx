...
export default function NegotiationPanel({ isOpen, onToggle, selectedChat, onBack, isMobile }) {
    ...
    return (
      <div className="w-full bg-white flex flex-col h-full">
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Negosiasi</h2>
            <p className="text-gray-600">Lakukan negosiasi dengan mudah!</p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-base"
              rows={3}
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none text-base"
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-20 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-base"
                min="1"
              />
              <select
                value={formData.durationUnit}
                onChange={(e) => handleInputChange("durationUnit", e.target.value)}
                className="p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base"
              >
  ...
  return (
    <div className="w-80 bg-white border-l border-gray-200 flex flex-col h-full">
      ...
      <div className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        {/* Duration */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">Durasi Bekerja</label>
          <div className="flex items-center gap-2">
            <input
              type="number"
              value={formData.duration}
              onChange={(e) => handleInputChange("duration", e.target.value)}
              className="w-16 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center"
              min="1"
            />
            <select
              value={formData.durationUnit}
        ...
        {/* Tariff */}
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">Tarif</label>
          <input
            type="number"
            value={formData.tariff}
            onChange={(e) => handleInputChange("tariff", e.target.value)}
