...
export default function ChatWindow({ selectedChat, onToggleNegotiation, isNegotiationOpen, onBack, isMobile }) {
  ...
  if (!selectedChat) {
    return null // Don't render anything on mobile when no chat is selected
  }
